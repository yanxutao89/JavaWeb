...
import com.yxt.crud.annotations.JsonField;
import com.yxt.crud.exception.InvalidJsonValueFormatException;
...
import static com.yxt.crud.utils.ValidationUtils.isTrue;

public class TypeUtils {

	private static final String[] SUPPORTED_DATA_TYPES = { "string", "number", "boolean", "null" };

	private TypeUtils() throws Exception {
