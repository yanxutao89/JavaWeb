...
public final class RedisUtils {
    ...
    public void multiHmset(List<Map<String, String>> list, String key, String hkey, String hvalue) {
        ...
        redisTemplate.executePipelined(new RedisCallback<List<Map<String, String>>>() {
            ...
            public List<Map<String, String>> doInRedis(RedisConnection connection) throws DataAccessException {
                for (Map<String, String> map : list) {
                    ...
                    connection.hSet(stringRedisSerializer.serialize(map.get(key)),
                            stringRedisSerializer.serialize(map.get(hkey)),
                            valueSerializer.serialize(map.get(hvalue)));
                }
                return null;
            }
        });
